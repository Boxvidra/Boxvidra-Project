...
- `أمر تثبيت محاكي بوكسڤيدرا` :
```bash
'سيكون متوفراً في ٦/١٩، ترقبوا.'
```
* ### أوامر محاكي بوكسڤيدرا :
* `boxvidra` لتشغيل القائمة الرئيسية لمحاكي بوكسڤيدرا
* `boxvidra --update` لتحديث محاكي بوكسڤيدرا
* `boxvidra --reinstall` لإعادة تثبيت محاكي بوكسڤيدرا
* `boxvidra --uninstall` لإلغاء تثبيت محاكي بوكسڤيدرا
