...
```
* ### أوامر محاكي إكس بوكس ڤيدرا :
* `xboxvidra` لتشغيل محاكي إكس بوكس ڤيدرا 
* `xboxvidra --update` لتحديث محاكي إكس بوكس ڤيدرا
* `xboxvidra --reinstall` لإعادة تثبيت محاكي إكس بوكس ڤيدرا
* `xboxvidra --uninstall` لإلغاء تثبيت محاكي إكس بوكس ڤيدرا

#

<a name="xboxvidra-requirements"></a>
* ### متطلبات محاكي إكس بوكس ڤيدرا :
| المتطلبات           | المطلوب                |
|---------------------|------------------------|
| إصدار الأندرويد    | ١٠ وما فوق             |
| المعالج            | سنابدراغون ٤٨٠ وما فوق  |
| الرام               | من ٢ إلى ٤ رام         |
| التخزين            | من ١ إلى ٢ جيجابايت     |
| عملية التثبيت       | ١ جيجابايت             |

#

### الإعدادات الموصى بها لمحاكي إكس بوكس ڤيدرا : <a name="xboxvidra-recommended-settings"></a>

| الإعداد            | التفاصيل                               |
|--------------------|----------------------------------------|
| هيكل الواجهة       | هيكل واجهة إكس بوكس (`أخضر فاتح`، `أخضر داكن`) |
...
| **وضع الدقة**                                      | مطابق                                                                                             |
| **الدقة**                                          | ١٢٨٠×٧٢٠                                                                                         |
| **فرض وضع العرض الأفقي**                           | مفعل                                                                                            |
| **إعادة تهيئة الشاشة أثناء فتح لوحة المفاتيح الناعمة** | غير مفعل                                                                                          |
| **إظهار لوحة مفاتيح إضافية**                        | غير مفعل                                                                                          |
| **تكبير الشاشة إلى العرض الكامل على الجهاز**         | مفعل                                                                                            |
| **وضع إدخال شاشة اللمس**                            | - لوحة لمس لـ `استنادًا إلى إصدار بوكسڤيدرا (البرنامج)` <br> - لمس مباشر لـ `هيكل المحاكي`        |
