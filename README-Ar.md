...
| الإعداد                  | التفاصيل                                                                                         |
|--------------------------|--------------------------------------------------------------------------------------------------|
| **النوى الأساسية**       | `8` نوى                                                                                         |
| **دايناريك**              | `45`                                                                                            |
| **النبيذ - Wow64**         | `8.18` Staging                                                                                  |
| **النبيذ - Box86-64**      | `8.25` GE                                                                                       |
| **هيكل الواجهة**         | هيكل نظام ويندوز ٢٠ (`فاتح`، `داكن`) <br> هيكل نظام تطبيق بوكسڤيدرا (`بنفسجي فاتح`، `أزرق داكن`) |

* ### الإعدادات الموصى بها لتيرمكس إكس-١١ :
...
| **وضع إدخال شاشة اللمس**                            | - لوحة لمس لـ `وضع سطح المكتب` و `الوضع الصغير` <br> - لمس مباشر لـ `وضع التطبيق`                 |

<a name="boxvidra-previews"></a>
* ### معاينات محاكي بوكسڤيدرا :
- **`غير متوفرة`**

<a name="boxvidra-experiments"></a>
* ### تجارب محاكي بوكسڤيدرا :
- **`غير متوفرة`**
