...
**`حسناً، لدينا ثلاث أوضاع لمحاكي بوكسڤيدرا، والوضع الأساسي هو وضع سطح المكتب :`** وهو وضع يسمح للمستخدم باستخدام عدة بنيات نظامية أهمها ويندوز ١٠، ويندوز ١١، ويندوز ٧، ويسمح للمستخدم بتشغيل برامج عديدة مثل متصفحات الويب، محررات النصوص، برامج التواصل الاجتماعي، تشغيل الفيديو، وغيرها الكثير. كما يتيح للمستخدم تجربة كاملة وحقيقية للنظام المختار، ونقدم هنا أيضاً بيئة تطوير جديدة ومختلفة تماماً على نظام سطح مكتب إكس إف سي إى.

<a name="application-mode"></a>
**`الوضع الثاني والأهم هو وضع التطبيق :`** حيث يعمل هذا الوضع بطريقة مختلفة وجديدة كلياً، وفكرته تقديم بنية نظام تطبيق متكاملة تعمل مثل برنامج فعلي، والفرق الوحيد هو أنه يُشغل من طرفية تيرمكس، وكل ما يُنفّذ من خلال واجهة التطبيق يُعرض على x11، كأنك تستخدم برنامجاً حقيقياً. كما يدعم ميزة الحاويات دون أية مشاكل، مع العديد من المزايا.

<a name="tiny-mode"></a>
**`الوضع الثالث والأخير هو الوضع الخفيف :`** وهو أسرع وأكثر استقراراً، ويتيح للمستخدم استخدام برامج لينكس فقط، لذا لن يتمكن المستخدم من استخدام خدمات واين مطلقاً في هذا الوضع.
