...
**`بمجرد أن تضع الأمر في طرفية تيرمكس، ستبدأ عملية التثبيت بالكامل بدون أي تدخل من المستخدم، تستغرق عملية التثبيت من ٥ إلى ٢٠ دقيقة، حسب سرعة الإنترنت.`**

<a name="xboxvidra-installation-command"></a>
- `أمر تثبيت محاكي إكس بوكس ڤيدرا` :
```bash
'سيكون متاحًا في ١١/٢٤، ترقبوا.'
```
